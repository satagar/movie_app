...
router.put("/movie_app/api/v1/theatres/:id", tokenValidator.validateToken, isAdminValidation.isAdmin, theatreValidator.theatreValidate, theatreController.update);
...
router.put("/movie_app/api/v2/theatres/:id/movies", tokenValidator.validateToken, isAdminValidation.isAdmin, theatreMovieController.addMovieToTheatre);
